...
describe('hoverIntent', function() {
  ...
  function mouse(eventType, x, y, options) {
    let eventOptions = Object.assign({
      bubbles: true, clientX: x, clientY: y, pageX: x, pageY: y, target: elem5,
    }, options || {});

    elem5.dispatchEvent(new MouseEvent(eventType, eventOptions));
  }
  ...
  it('mouseover -> followed by fast mouseout leads doesn\'t show tooltip',
      function() {
        mouse('mouseover', 10, 10);
        setTimeout(
